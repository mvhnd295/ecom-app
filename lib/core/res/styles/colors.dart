...
class AppColors {
  ...
  static const MaterialColor primaryMaterialColor =
      MaterialColor(0xFF7B61FF, <int, Color>{
        50: Color(0xFFEDEBFF),
        100: Color(0xFFC9C6FF),
        200: Color(0xFFA3A0FF),
        300: Color(0xFF7B79FF),
        400: Color(0xFF5F5EFF),
        500: Color(0xFF7B61FF),
        600: Color(0xFF734FFF),
        700: Color(0xFF683CFF),
        800: Color(0xFF5E2AFF),
        900: Color(0xFF4A0BFF),
      });
